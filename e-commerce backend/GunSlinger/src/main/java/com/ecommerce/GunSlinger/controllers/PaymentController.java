...
import com.ecommerce.GunSlinger.response.PaymentLinkResponse;
...
public class PaymentController {
	...
	@GetMapping("/payments")
	public ResponseEntity<ApiResponse> redirect(@RequestParam(name="payment_id") String paymentId, @RequestParam(name = "order_id") Long orderId) throws RazorpayException, OrderException{
